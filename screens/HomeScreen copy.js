...
const HomeScreen = () => {
  ...
  const renderItem = ({ item }) => {
    (
      ...
      //   source={{ uri: 'https://ii1.pepperfry.com/media/catalog/product/m/o/568x625/modern-chaise-lounger-in-grey-colour-by-dreamzz-furniture-modern-chaise-lounger-in-grey-colour-by-dr-tmnirx.jpg' }}
      // />
      <Text>{item.text}</Text>
    )
  }
  return (
    < >
      ...
      <Text style={{ flex: 1, backgroundColor: "blue" }}>selam</Text> */}
      <FlatList
